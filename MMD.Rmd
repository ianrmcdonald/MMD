...
---
Install the libraries and create an R data frame from the downloaded Shor McCarty 1993-2015 state individual legislator file.  Creates npat_june_2015, and npat_master, which includes name, party, state, member_id and np_score
